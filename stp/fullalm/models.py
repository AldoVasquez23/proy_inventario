...
# ------>  Importando para BASES
from django.contrib.auth.models import User
# from django_userforeignkey.models.fields import UserForeignKey

# ------> Importando para [CMP, FAC]
...
class Cecofinal(ClaseModelo):
    ...
    cecos = models.CharField(db_column='CECOS', max_length=255, blank=True, null=True)  # Field name made lowercase.
    depend = models.FloatField(db_column='DEPEND', blank=True, null=True)  # Field name made lowercase.
    cebes = models.CharField(db_column='CEBES', max_length=255, blank=True, null=True)  # Field name made lowercase.
    ceges = models.CharField(db_column='CEGES', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class Destino(ClaseModelo):
    ...
    desdestino = models.CharField(db_column='DesDestino', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Imaterial(ClaseModelo):
    ...
    bukrs = models.CharField(db_column='BUKRS', max_length=4, blank=True, null=True)  # Field name made lowercase.
    mjahr = models.IntegerField(db_column='MJAHR', blank=True, null=True)  # Field name made lowercase.
    werks = models.CharField(db_column='WERKS', max_length=4, blank=True, null=True)  # Field name made lowercase.
    lgort = models.CharField(db_column='LGORT', max_length=4, blank=True, null=True)  # Field name made lowercase.
    bwart = models.CharField(db_column='BWART', max_length=3, blank=True,null=True)  # Field name made lowercase.
    mblnr = models.CharField(db_column='MBLNR', max_length=10, blank=True, null=True)  # Field name made lowercase.
    zeile = models.IntegerField(db_column='ZEILE', blank=True, null=True)  # Field name made lowercase.
    budat = models.CharField(db_column='BUDAT', max_length=8, blank=True, null=True)  # Field name made lowercase.
    usnam = models.CharField(db_column='USNAM', max_length=12, blank=True, null=True)  # Field name made lowercase.
    matnr = models.CharField(db_column='MATNR', max_length=18, blank=True, null=True)  # Field name made lowercase.
    maktx = models.CharField(db_column='MAKTX', max_length=40, blank=True, null=True)  # Field name made lowercase.
    erfmg = models.DecimalField(db_column='ERFMG', max_digits=13, decimal_places=3, blank=True, null=True)  # Field name made lowercase.
    erfme = models.CharField(db_column='ERFME', max_length=3, blank=True, null=True)  # Field name made lowercase.
    dmbtr = models.DecimalField(db_column='DMBTR', max_digits=13, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    waers = models.CharField(db_column='WAERS', max_length=5, blank=True, null=True)  # Field name made lowercase.
    aufnr = models.CharField(db_column='AUFNR', max_length=12, blank=True, null=True)  # Field name made lowercase.
    rsnum = models.CharField(db_column='RSNUM', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ...
    smbln = models.CharField(db_column='SMBLN', max_length=10, blank=True, null=True)  # Field name made lowercase.
    smblp = models.IntegerField(db_column='SMBLP', blank=True, null=True)  # Field name made lowercase.
    xblnr = models.CharField(db_column='XBLNR', max_length=16, blank=True, null=True)  # Field name made lowercase.
    auart = models.CharField(db_column='AUART', max_length=4, blank=True, null=True)  # Field name made lowercase.
...
class Item2(ClaseModelo):
    nivel_contrato = models.FloatField(db_column='nivel contrato', blank=True, null=True)  # Field renamed to remove unsuitable characters.
    detalle = models.CharField(max_length=255, blank=True, null=True)
    unidad = models.CharField(max_length=255, blank=True, null=True)
    pu_field = models.FloatField(db_column='pu ', blank=True, null=True)  # Field renamed to remove unsuitable characters. Field renamed because it ended with '_'.
...
class Mataut(ClaseModelo):
    ...
    idgerencia = models.IntegerField(db_column='IDGerencia', blank=True, null=True)  # Field name made lowercase.
    idunidad = models.IntegerField(db_column='IDUnidad', blank=True, null=True)  # Field name made lowercase.
    flagrev = models.CharField(db_column='FlagRev', max_length=1, blank=True, null=True)  # Field name made lowercase.
    flagaut = models.CharField(db_column='FlagAut', max_length=1, blank=True, null=True)  # Field name made lowercase.
    ...
    flaging = models.CharField(db_column='FlagIng', max_length=1, blank=True, null=True)  # Field name made lowercase.
    flagcom = models.CharField(db_column='FlagCom', max_length=1, blank=True, null=True)  # Field name made lowercase.
    flagreving = models.CharField(db_column='FlagRevIng', max_length=1, blank=True, null=True)  # Field name made lowercase.
    flagliqui = models.CharField(db_column='FlagLiqui', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class Notdet(ClaseModelo):
    nrosolsal = models.BigIntegerField(db_column='NroSolSal', blank=True, null=False, primary_key=True)  # Field name made lowercase.
    nroressap = models.CharField(db_column='NroResSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nrosapsal = models.CharField(db_column='NroSapSal', max_length=20, blank=True, null=True)  # Field name made lowercase.
    item = models.IntegerField(db_column='Item', blank=True, null=True)  # Field name made lowercase.
    codmat = models.CharField(db_column='CodMat', max_length=10, blank=True, null=True)  # Field name made lowercase.
    cantidad = models.DecimalField(db_column='Cantidad', max_digits=15, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class Noting(ClaseModelo):
    ...
    almacen = models.CharField(db_column='Almacen', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ...
    emplaza = models.CharField(db_column='Emplaza', max_length=10, blank=True, null=True)  # Field name made lowercase.
    empresa = models.CharField(db_column='Empresa', max_length=10, blank=True, null=True)  # Field name made lowercase.
    codtiping = models.IntegerField(db_column='CodTipIng', blank=True, null=True)  # Field name made lowercase.
    motivo = models.CharField(db_column='Motivo', max_length=350, blank=True, null=True)  # Field name made lowercase.
    nrosolsal = models.IntegerField(db_column='NroSolSal', blank=True, null=True)  # Field name made lowercase.
    entcodigo = models.CharField(db_column='EntCodigo', max_length=10, blank=True, null=True)  # Field name made lowercase.
    codrevision = models.CharField(db_column='CodRevision', max_length=10, blank=True, null=True)  # Field name made lowercase.
    codalmacenero = models.CharField(db_column='CodAlmacenero', max_length=10, blank=True, null=True)  # Field name made lowercase.
    nroordensap = models.CharField(db_column='NroOrdenSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    estnoting = models.CharField(db_column='EstNotIng', max_length=1, blank=True, null=True)  # Field name made lowercase.
    nroorden = models.CharField(db_column='NroOrden', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nrosapsal = models.CharField(db_column='NroSapSal', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nroressal = models.CharField(db_column='NroResSal', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nroingsap = models.CharField(db_column='NroIngSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nroguia = models.CharField(db_column='NroGuia', max_length=20, blank=True, null=True)  # Field name made lowercase.
    codurs = models.IntegerField(db_column='CodUrs', blank=True, null=True)  # Field name made lowercase.
    observacion = models.CharField(db_column='Observacion', max_length=350, blank=True, null=True)  # Field name made lowercase.
    calificacion = models.CharField(db_column='Calificacion', max_length=1, blank=True, null=True)  # Field name made lowercase.
    fecanu = models.DateTimeField(db_column='FecAnu', blank=True, null=True)  # Field name made lowercase.
    desanu = models.CharField(db_column='DesAnu', max_length=350, blank=True, null=True)  # Field name made lowercase.
    codanu = models.CharField(db_column='CodAnu', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
class Notingdet(ClaseModelo):
    nrosoling = models.BigIntegerField(db_column='NroSolIng', blank=True, null=False, primary_key=True)  # Field name made lowercase.
    nroing = models.BigIntegerField(db_column='NroIng', blank=True, null=True)  # Field name made lowercase.
    nroingsap = models.CharField(db_column='NroIngSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    item = models.IntegerField(db_column='Item', blank=True, null=True)  # Field name made lowercase.
    codmat = models.CharField(db_column='CodMat', max_length=10, blank=True,  null=True)  # Field name made lowercase.
    cantidad = models.DecimalField(db_column='Cantidad', max_digits=15, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    codaf = models.CharField(db_column='CodAF', max_length=20, blank=True, null=True)  # Field name made lowercase.
    codafsap = models.CharField(db_column='CodAFSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nroordensap = models.CharField(db_column='NroOrdenSAP', max_length=20, blank=True, null=True)  # Field name made lowercase.
    condini = models.CharField(db_column='CondIni', max_length=50, blank=True, null=True)  # Field name made lowercase.
    condfin = models.CharField(db_column='Condfin', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Notsal(ClaseModelo):
    ...
    emplaza = models.CharField(db_column='Emplaza', max_length=10, blank=True, null=True)  # Field name made lowercase.
    empresa = models.CharField(db_column='Empresa', max_length=10, blank=True, null=True)  # Field name made lowercase.
    solcodigo = models.CharField(db_column='SolCodigo', max_length=10, blank=True, null=True)  # Field name made lowercase.
    reccodigo = models.CharField(db_column='RecCodigo', max_length=10, blank=True, null=True)  # Field name made lowercase.
    codrevision = models.CharField(db_column='CodRevision', max_length=10, blank=True, null=True)  # Field name made lowercase.
    codautorizador = models.CharField(db_column='CodAutorizador', max_length=10, blank=True, null=True)  # Field name made lowercase.
    nroordensap = models.CharField(db_column='NroOrdenSap', max_length=20, blank=True, null=True)  # Field name made lowercase.
    locdes = models.CharField(db_column='LocDes', max_length=10, blank=True, null=True)  # Field name made lowercase.
    estliq = models.CharField(db_column='Estliq', max_length=1, blank=True, null=True)  # Field name made lowercase.
    estnotsal = models.CharField(db_column='EstNotSal', max_length=1, blank=True, null=True)  # Field name made lowercase.
    nroorden = models.CharField(db_column='NroOrden', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nrosapsal = models.CharField(db_column='NroSapSal', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nroressal = models.CharField(db_column='NroResSal', max_length=20, blank=True, null=True)  # Field name made lowercase.
    descripcion = models.CharField(db_column='Descripcion', max_length=350, blank=True, null=True)  # Field name made lowercase.
    observacion = models.CharField(db_column='Observacion', max_length=350, blank=True, null=True)  # Field name made lowercase.
    fecrec = models.DateTimeField(db_column='FecRec', blank=True, null=True)  # Field name made lowercase.
    desrec = models.CharField(db_column='DesRec', max_length=350, blank=True, null=True)  # Field name made lowercase.
    codrec = models.CharField(db_column='CodRec', max_length=10, blank=True, null=True)  # Field name made lowercase.
    fecanu = models.DateTimeField(db_column='FecAnu', blank=True, null=True)  # Field name made lowercase.
    desanu = models.CharField(db_column='DesAnu', max_length=350, blank=True, null=True)  # Field name made lowercase.
    codanu = models.CharField(db_column='CodAnu', max_length=10, blank=True, null=True)  # Field name made lowercase.
    fecdes = models.CharField(db_column='FecDes', max_length=10, blank=True, null=True)  # Field name made lowercase.
...
class OtActividades(ClaseModelo):
    ...
    detalle = models.CharField(db_column='Detalle', max_length=190, blank=True, null=True)  # Field name made lowercase.
    ...
    codantiguo = models.CharField(db_column='CodAntiguo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    idcontrato = models.IntegerField(db_column='IDContrato', blank=True, null=True)  # Field name made lowercase.
    ...
    ctatipo = models.CharField(db_column='CtaTipo', max_length=1, blank=True, null=True)  # Field name made lowercase.
    ctastipo = models.CharField(db_column='CtaSTipo', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class OtAlmatipot(ClaseModelo):
    ...
    descripciontt = models.CharField(db_column='DescripcionTT', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class OtAlmacenes(ClaseModelo):
    ...
    unidad = models.CharField(db_column='Unidad', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class OtAreaadm(ClaseModelo):
    ...
    alias = models.CharField(db_column='Alias', max_length=3, blank=True, null=True)  # Field name made lowercase.
...
class OtAreacontrato(ClaseModelo):
    ...
    idcontrato = models.ForeignKey('OtContratos', models.DO_NOTHING, db_column='IDContrato')  # Field name made lowercase.
    idareaadm = models.ForeignKey('OtAreaadm', models.DO_NOTHING, db_column='IDAreaAdm')  # Field name made lowercase.
...
class OtAreanivel(ClaseModelo):
    idareaadm = models.ForeignKey('OtAreaadm', models.DO_NOTHING,db_column='IDAreaAdm', primary_key=True)  # Field name made lowercase.
...
class OtContratos(ClaseModelo):
    ...
    contratista = models.ForeignKey('OtContratistas', models.DO_NOTHING, db_column='Contratista')  # Field name made lowercase.
    ...
    montocontrato = models.DecimalField(db_column='MontoContrato', max_digits=18, decimal_places=2)  # Field name made lowercase.
...
class OtContratosB(ClaseModelo):
    ...
    contrato = models.CharField(db_column='Contrato', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class OtDatos(ClaseModelo):
    igv = models.DecimalField(db_column='IGV', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    version = models.CharField(db_column='Version', max_length=50, blank=True, null=False, primary_key=True)  # Field name made lowercase.
...
class OtDisalmacenes(ClaseModelo):
    ...
    idreclamo = models.ForeignKey('OtReclamo', models.DO_NOTHING, db_column='IDReclamo')  # Field name made lowercase.
    idmovalm = models.ForeignKey('OtMovalmacenes', models.DO_NOTHING, db_column='IDMovAlm')  # Field name made lowercase.
...
class OtEstadosolicitud(ClaseModelo):
    ...
    sol_descripcion = models.CharField(db_column='SOL_Descripcion', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class OtFactibilidadact(ClaseModelo):
    idactfactibilidad = models.AutoField(db_column='IDActFactibilidad', primary_key=True)  # Field name made lowercase.
    ...
    fecha = models.DateTimeField(db_column='Fecha')  # Field name made lowercase.
    cantidadpre = models.DecimalField(db_column='CantidadPre', max_digits=10, decimal_places=2)  # Field name made lowercase.
    idnivel = models.IntegerField(db_column='IDNivel', blank=True, null=True)  # Field name made lowercase.
    costo = models.DecimalField(db_column='Costo', max_digits=10, decimal_places=2)  # Field name made lowercase.
...
class OtFactibilidades(ClaseModelo):
    idfactibilidad = models.AutoField(db_column='IDFactibilidad', primary_key=True)  # Field name made lowercase.
    ...
    docorigen = models.CharField(db_column='DocOrigen', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    cuadrillaeje = models.CharField(db_column='CuadrillaEje', max_length=50, blank=True, null=True)  # Field name made lowercase.
    estado = models.SmallIntegerField(db_column='Estado')  # Field name made lowercase.
    ...
    montofac = models.DecimalField(db_column='MontoFac', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    referencia = models.CharField(db_column='Referencia', max_length=150, blank=True, null=True)  # Field name made lowercase.
    nroanterior = models.CharField(db_column='NroAnterior', max_length=20, blank=True, null=True)  # Field name made lowercase.
    tranfer = models.CharField(db_column='Tranfer', max_length=10)  # Field name made lowercase.
    nivelfactibilidad = models.IntegerField(db_column='NivelFactibilidad', blank=True, null=True)  # Field name made lowercase.
    ...
    fechaalmacen = models.DateTimeField(db_column='FechaAlmacen', blank=True, null=True)  # Field name made lowercase.
    penalizada = models.BooleanField(db_column='Penalizada', blank=True, null=True)  # Field name made lowercase.
    ...
    gastos = models.DecimalField(db_column='Gastos', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class OtGrupos(ClaseModelo):
    ...
    contrato = models.ForeignKey('OtContratos', models.DO_NOTHING, db_column='Contrato')  # Field name made lowercase.
    fechafac = models.DateTimeField(db_column='FechaFac', blank=True, null=True)  # Field name made lowercase.
    nrodoc = models.CharField(db_column='NroDoc', max_length=30, blank=True, null=True)  # Field name made lowercase.
    ...
    localidad = models.ForeignKey('OtLocalidad', models.DO_NOTHING, db_column='Localidad')  # Field name made lowercase.
    permodi = models.IntegerField(db_column='PerModi', blank=True, null=True)  # Field name made lowercase.
    montoamor = models.DecimalField(db_column='MontoAmor', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    montosub = models.DecimalField(db_column='MontoSub', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    igva = models.DecimalField(db_column='IGVA', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    totala = models.DecimalField(db_column='TotalA', max_digits=12, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    igvt = models.DecimalField(db_column='IGVT', max_digits=10, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    totalt = models.DecimalField(db_column='TotalT', max_digits=12, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class OtLiquidaciones(ClaseModelo):
    ...
    cantidad = models.DecimalField(db_column='Cantidad', max_digits=8, decimal_places=2)  # Field name made lowercase.
...
class OtLocalidad(ClaseModelo):
    ...
    nombre = models.CharField(db_column='Nombre', max_length=50)  # Field name made lowercase.
    cod2 = models.CharField(db_column='Cod2', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class OtLogsp(ClaseModelo):
    ...
    idpresupuesto = models.IntegerField(db_column='IDPresupuesto', blank=True, null=True)  # Field name made lowercase.
    estado = models.SmallIntegerField(db_column='Estado')  # Field name made lowercase.
    persona = models.IntegerField(db_column='Persona')  # Field name made lowercase.
    fecha = models.DateTimeField(db_column='Fecha')  # Field name made lowercase.
...
class OtMovalmacenes(ClaseModelo):
    idot = models.IntegerField(db_column='IDOT')  # Field name made lowercase.
    codigo = models.IntegerField(db_column='Codigo')  # Field name made lowercase.
    salida = models.DecimalField(db_column='Salida', max_digits=8, decimal_places=2)  # Field name made lowercase.
    ingreso = models.DecimalField(db_column='Ingreso', max_digits=8, decimal_places=2)  # Field name made lowercase.
    docsalida = models.DecimalField(db_column='DocSalida', max_digits=18, decimal_places=0)  # Field name made lowercase.
    docingreso = models.DecimalField(db_column='DocIngreso', max_digits=18, decimal_places=0)  # Field name made lowercase.
    tipo = models.SmallIntegerField(db_column='Tipo')  # Field name made lowercase.
    fechasalida = models.CharField(db_column='FechaSalida', max_length=50, blank=True, null=True)  # Field name made lowercase.
    fechaingreso = models.CharField(db_column='FechaIngreso', max_length=50, blank=True, null=True)  # Field name made lowercase.
    nrosolicitud = models.IntegerField(db_column='NroSolicitud')  # Field name made lowercase.
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    liquidado = models.DecimalField(db_column='Liquidado', max_digits=8, decimal_places=2)  # Field name made lowercase.
...
class OtMovalmacenes7(ClaseModelo):
    ...
    salida = models.DecimalField(db_column='Salida', max_digits=8, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    ingreso = models.DecimalField(db_column='Ingreso', max_digits=8, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    docsalida = models.DecimalField(db_column='DocSalida', max_digits=18, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    docingreso = models.DecimalField(db_column='DocIngreso', max_digits=18, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    tipo = models.SmallIntegerField(db_column='Tipo', blank=True, null=True)  # Field name made lowercase.
    fechasalida = models.CharField(db_column='FechaSalida', max_length=50, blank=True, null=True)  # Field name made lowercase.
    fechaingreso = models.CharField(db_column='FechaIngreso', max_length=50, blank=True, null=True)  # Field name made lowercase.
    nrosolicitud = models.DecimalField(db_column='NroSolicitud', max_digits=18, decimal_places=0, blank=True, null=True)  # Field name made lowercase.
    id = models.AutoField(db_column='ID', primary_key=True)  # Field name made lowercase.
    liquidado = models.DecimalField(db_column='Liquidado', max_digits=8, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class OtNiif(ClaseModelo):
    ...
    idactividad = models.CharField(db_column='IdActividad', max_length=3, blank=True, null=True)  # Field name made lowercase.
    idcuenta = models.CharField(db_column='IdCuenta', max_length=3, blank=True, null=True)  # Field name made lowercase.
    idtipo = models.CharField(db_column='IdTipo', max_length=3, blank=True, null=True)  # Field name made lowercase.
    idubicacion = models.CharField(db_column='IdUbicacion', max_length=5, blank=True, null=True)  # Field name made lowercase.
    idcomponente = models.CharField(db_column='IdComponente', max_length=4, blank=True, null=True)  # Field name made lowercase.
    idelemento = models.CharField(db_column='IdElemento', max_length=4, blank=True, null=True)  # Field name made lowercase.
...
class OtNivelcontrato(ClaseModelo):
    ...
    localidad = models.ForeignKey('OtLocalidad', models.DO_NOTHING, db_column='Localidad', blank=True, null=True)  # Field name made lowercase.
...
class OtNodoreferencia(ClaseModelo):
    idnodoreferencia = models.AutoField(db_column='IDNodoReferencia', primary_key=True)  # Field name made lowercase.
    nombre = models.CharField(db_column='Nombre', max_length=50)  # Field name made lowercase.
...
class OtNodos(ClaseModelo):
    ...
    idot = models.ForeignKey('OtOts', models.DO_NOTHING, db_column='IDOT', blank=True, null=True)  # Field name made lowercase.
    codigo = models.CharField(db_column='Codigo', max_length=20)  # Field name made lowercase.
    tiponodo = models.ForeignKey('OtTiponodo', models.DO_NOTHING, db_column='TipoNodo')  # Field name made lowercase.
    referencia = models.CharField(db_column='Referencia', max_length=200, blank=True, null=True)  # Field name made lowercase.
    observacion = models.CharField(db_column='Observacion', max_length=200, blank=True, null=True)  # Field name made lowercase.
    usuariomod = models.IntegerField(db_column='UsuarioMod', blank=True, null=True)  # Field name made lowercase.
    ant = models.IntegerField(blank=True, null=True)
    idpresupuesto = models.IntegerField(db_column='IDPresupuesto', blank=True, null=True)  # Field name made lowercase.
    idfactibilidad = models.IntegerField(db_column='IDFactibilidad', blank=True, null=True)  # Field name made lowercase.
...
class OtOtpen(ClaseModelo):
    ...
    cantidad = models.DecimalField(db_column='Cantidad', max_digits=18, decimal_places=4)  # Field name made lowercase.
    fecha = models.DateTimeField(db_column='Fecha')  # Field name made lowercase.
    idtipopenalidad = models.IntegerField(db_column='IDTipoPenalidad', blank=True, null=True)  # Field name made lowercase.
    costo = models.DecimalField(db_column='Costo', max_digits=18, decimal_places=2)  # Field name made lowercase.
...
class OtOts(ClaseModelo):
    ...
    recepcionada = models.BooleanField(db_column='Recepcionada', blank=True, null=True)  # Field name made lowercase.
    ...
    codgrupo = models.CharField(db_column='CodGrupo', max_length=15, blank=True, null=True)  # Field name made lowercase.
    fechaalmacen = models.DateTimeField(db_column='FechaAlmacen', blank=True, null=True)  # Field name made lowercase.
    penalizada = models.BooleanField(db_column='Penalizada', blank=True, null=True)  # Field name made lowercase.
    fechareccontra = models.DateTimeField(db_column='FechaRecContra', blank=True, null=True)  # Field name made lowercase.
    perreccontra = models.IntegerField(db_column='PerRecContra', blank=True, null=True)  # Field name made lowercase.
    fecaproba = models.DateTimeField(db_column='FecAproba', blank=True, null=True)  # Field name made lowercase.
    peraproba = models.IntegerField(db_column='PerAproba', blank=True, null=True)  # Field name made lowercase.
    materiales = models.BooleanField(db_column='Materiales', blank=True, null=True)  # Field name made lowercase.
    ...
    plazoejeh = models.SmallIntegerField(db_column='PlazoEjeH', blank=True, null=True)  # Field name made lowercase.
    ...
    prctr = models.CharField(db_column='PRCTR', max_length=10, blank=True, null=True)  # Field name made lowercase.
    kostv = models.CharField(db_column='KOSTV', max_length=10, blank=True, null=True)  # Field name made lowercase.
    veraa_user = models.CharField(db_column='VERAA_USER', max_length=12, blank=True, null=True)  # Field name made lowercase.
    akstl = models.CharField(db_column='AKSTL', max_length=10, blank=True, null=True)  # Field name made lowercase.
    nrosap = models.CharField(db_column='NROSAP', max_length=12, blank=True, null=True)  # Field name made lowercase.
    tipocuenta = models.IntegerField(db_column='TipoCuenta', blank=True, null=True)  # Field name made lowercase.
    gerencia = models.CharField(db_column='GERENCIA', max_length=1, blank=True, null=True)  # Field name made lowercase.
    otnueva = models.CharField(db_column='OTNUEVA', max_length=12, blank=True, null=True)  # Field name made lowercase.
    otblo = models.CharField(db_column='OTBLO', max_length=1, blank=True, null=True)  # Field name made lowercase.
    otfr1 = models.CharField(db_column='OTFR1', max_length=1, blank=True, null=True)  # Field name made lowercase.
    otfr2 = models.CharField(db_column='OTFR2', max_length=1, blank=True, null=True)  # Field name made lowercase.
    flagplazo = models.CharField(db_column='FlagPlazo', max_length=1, blank=True, null=True)  # Field name made lowercase.
...
class OtObservaciones(ClaseModelo):
    ...
    perdescarga = models.IntegerField(db_column='PerDescarga', blank=True, null=True)  # Field name made lowercase.
...
class OtPedmaterial(ClaseModelo):
    ...
    noid = models.CharField(db_column='NoID', max_length=20, blank=True, null=True)  # Field name made lowercase.
    nodesc = models.CharField(db_column='NODesc', max_length=50, blank=True, null=True)  # Field name made lowercase.
    estadosol = models.IntegerField(db_column='EstadoSol')  # Field name made lowercase.
    nrosolicitud = models.CharField(db_column='NroSolicitud', max_length=20, blank=True, null=True)  # Field name made lowercase.
    ...
    observacionessol = models.CharField(db_column='ObservacionesSol', max_length=500, blank=True, null=True)  # Field name made lowercase.
    codrecepciona = models.CharField(db_column='CodRecepciona', max_length=8, blank=True, null=True)  # Field name made lowercase.
    ...
    observacionesdev = models.CharField(db_column='ObservacionesDev', max_length=500, blank=True, null=True)  # Field name made lowercase.
    coddevuelve = models.CharField(db_column='CodDevuelve', max_length=8, blank=True, null=True)  # Field name made lowercase.
    motivodev = models.CharField(db_column='MotivoDev', max_length=200, blank=True, null=True)  # Field name made lowercase.
    ...
    nrosolicituddev = models.CharField(db_column='NroSolicitudDev', max_length=20, blank=True, null=True)  # Field name made lowercase.
...
class OtPenalidad(ClaseModelo):
    ...
    adicional = models.CharField(db_column='Adicional', max_length=500, blank=True, null=True)  # Field name made lowercase.
    idcontrato = models.IntegerField(db_column='IDContrato')  # Field name made lowercase.
...
class OtPresupuestoact(ClaseModelo):
    idactpresupuesto = models.AutoField(db_column='IDActPresupuesto', primary_key=True)  # Field name made lowercase.
...
class OtPresupuestos(ClaseModelo):
    ...
    fine = models.DateTimeField(db_column='FinE', blank=True, null=True)  # Field name made lowercase.
    fechafac = models.DateTimeField(db_column='FechaFac', blank=True, null=True)  # Field name made lowercase.
    perfac = models.CharField(db_column='PerFac', max_length=10, blank=True, null=True)  # Field name made lowercase.
    montofac = models.DecimalField(db_column='MontoFac', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    referencia = models.CharField(db_column='Referencia', max_length=150, blank=True, null=True)  # Field name made lowercase.
    nroanterior = models.CharField(db_column='NroAnterior', max_length=20, blank=True, null=True)  # Field name made lowercase.
    tranfer = models.BooleanField(db_column='Tranfer')  # Field name made lowercase.
    nivelpresupuesto = models.IntegerField(db_column='NivelPresupuesto', blank=True, null=True)  # Field name made lowercase.
    ...
    peraproba = models.IntegerField(db_column='PerAproba', blank=True, null=True)  # Field name made lowercase.
    gastos = models.DecimalField(db_column='Gastos', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    norma = models.DecimalField(db_column='Norma', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
...
class OtReclamo(ClaseModelo):
    ...
    nombresolicitante = models.CharField(db_column='NombreSolicitante', max_length=200, blank=True, null=True)  # Field name made lowercase.
    direccionsolicitante = models.CharField(db_column='DireccionSolicitante', max_length=200, blank=True, null=True)  # Field name made lowercase.
    responsable = models.CharField(db_column='Responsable', max_length=50, blank=True, null=True)  # Field name made lowercase.
    descripcion = models.CharField(db_column='Descripcion', max_length=100, blank=True, null=True)  # Field name made lowercase.
    ...
    codigosuministro = models.IntegerField(db_column='CodigoSuministro', blank=True, null=True)  # Field name made lowercase.
    nombreamt = models.CharField(db_column='NombreAMT', max_length=100, blank=True, null=True)  # Field name made lowercase.
    nombresed = models.CharField(db_column='NombreSED', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    observacion = models.CharField(db_column='Observacion', max_length=200, blank=True, null=True)  # Field name made lowercase.
    idareaderiva = models.IntegerField(db_column='IDAreaDeriva', blank=True, null=True)  # Field name made lowercase.
    codigo = models.IntegerField(db_column='Codigo', blank=True, null=True)  # Field name made lowercase.
    ...
    acometida = models.DecimalField(db_column='Acometida', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    termico = models.DecimalField(db_column='Termico', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    regleta = models.DecimalField(db_column='Regleta', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    baston = models.DecimalField(db_column='Baston', max_digits=18, decimal_places=2, blank=True, null=True)  # Field name made lowercase.
    reubicacion = models.BooleanField(db_column='Reubicacion', blank=True, null=True)  # Field name made lowercase.
    atendido = models.BooleanField(db_column='Atendido', blank=True, null=True)  # Field name made lowercase.
    descripcionsolucion = models.CharField(db_column='DescripcionSolucion', max_length=200, blank=True, null=True)  # Field name made lowercase.
    fechasolucion = models.DateTimeField(db_column='FechaSolucion', blank=True, null=True)  # Field name made lowercase.
    resuelto = models.BooleanField(db_column='Resuelto', blank=True, null=True)  # Field name made lowercase.
    idperresuelto = models.IntegerField(db_column='IDPerResuelto', blank=True, null=True)  # Field name made lowercase.
    modoresuelto = models.CharField(db_column='ModoResuelto', max_length=200, blank=True, null=True)  # Field name made lowercase.
...
class OtUsuamp(ClaseModelo):
    codaut = models.IntegerField(db_column='CodAut', blank=True, null=False,
                                 primary_key=True)  # Field name made lowercase.
...
class OtUsuarioarea(ClaseModelo):
    idarea = models.ForeignKey('OtAreaadm', models.DO_NOTHING, db_column='IDArea',
                               primary_key=True)  # Field name made lowercase.
...
class Reservasabril(ClaseModelo):
    reserva = models.FloatField(db_column='Reserva', blank=True, null=False,
                                primary_key=True)  # Field name made lowercase.
...
class Cecosrural(ClaseModelo):
    ...
    descripcio = models.CharField(db_column='DESCRIPCIO', max_length=255, blank=True, null=True)  # Field name made lowercase.
...
class Proveedor(ClaseModelo):
    ...
    def save(self):
        self.descripcion = self.descripcion.upper()
        return super(Proveedor, self).save()
